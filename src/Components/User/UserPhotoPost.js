    ...
    return (
        <section className={` ${styles.photoPost} animeLeft`} >
            ...
            <form onSubmit={handleSubmit}>                            
                <Input label="Image - should be a JPG or PNG file with at least 1000 X 1000 pixels and can't be greater than 1MB:" className={styles.file} type="file" name="img" id="img" onChange={handleImgChange} accept="image/png, image/jpeg" required />
