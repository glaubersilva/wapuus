...
const About = () => {
    return (
        <section className="container" >            
            ...
            <p>As it's under the GPL license, anyone can <a className="link" target="_blank" rel="noreferrer" href="https://jawordpressorg.github.io/wapuu/faq_en.html">download the original version</a>, modify and redistribute it.</p><br/>
            <p>Lots of WordCamps, companies, and individuals around the world already created their own Wapuus versions, which helped this funny mascot become global.</p><br/>
            <p>You also can create your own Wapuus and use this web app as a place to share them! =)</p><br/>
